...
<table class="table table-bordered">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>{{$data->total}}</td>
            <td>
                <a class="btn btn-primary btn-sm" href="{{route('show.check-in',$data->id)}}">check In</a>
                <a class="btn btn-success btn-sm" href="{{route('show.check-out',$data->id)}}">check Out</a>
            </td>
        </tr>
